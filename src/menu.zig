...
pub const Menu = struct {
    ...
    pub fn handle(self: *Menu, cb: fn (w: ?*c.Fl_Menu_Bar, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Menu_Bar_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Menu, cb: fn (w: ?*c.Fl_Menu_Bar, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const MenuBar = struct {
    ...
    pub fn handle(self: *MenuBar, cb: fn (w: ?*c.Fl_Menu_Bar, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Menu_Bar_handle(self.inner, cb, data);
    }

    pub fn draw(self: *MenuBar, cb: fn (w: ?*c.Fl_Menu_Bar, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
        c.Fl_Menu_Bar_draw(self.inner, cb, data);
    }
};
...
pub const Choice = struct {
    ...
    pub fn handle(self: *Menu, cb: fn (w: ?*c.Fl_Choice, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Choice_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Menu, cb: fn (w: ?*c.Fl_Choice, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const SysMenuBar = struct {
    ...
    pub fn handle(self: *Menu, cb: fn (w: ?*c.Fl_Sys_Menu_Bar, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Sys_Menu_Bar_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Menu, cb: fn (w: ?*c.Fl_Sys_Menu_Bar, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
