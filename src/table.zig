...
pub const Table = struct {
    ...
    pub fn handle(self: *Table, cb: fn (w: *widget.Widget, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Table_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Table, cb: fn (w: *widget.Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const TableRow = struct {
    ...
    pub fn handle(self: *TableRow, cb: fn (w: *widget.Widget, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Table_Row_handle(self.inner, cb, data);
    }

    pub fn draw(self: *TableRow, cb: fn (w: *widget.Widget, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
