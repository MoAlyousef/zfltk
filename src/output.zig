...
pub const Output = struct {
    ...
    pub fn handle(self: *Output, cb: fn (w: WidgetPtr,  ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Output_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Output, cb: fn (w: WidgetPtr,  data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const MultilineOutput = struct {
    ...
    pub fn handle(self: *MultilineOutput, cb: fn (w: WidgetPtr,  ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Multiline_Output_handle(self.inner, cb, data);
    }

    pub fn draw(self: *MultilineOutput, cb: fn (w: WidgetPtr,  data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
