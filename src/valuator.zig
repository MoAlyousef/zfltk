...
pub const Valuator = struct {
    ...
    pub fn handle(self: *Valuator, cb: fn (w: ?*c.Fl_Slider, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Slider_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Valuator, cb: fn (w: ?*c.Fl_Slider, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Slider = struct {
    ...
    pub fn handle(self: *Slider, cb: fn (w: ?*c.Fl_Slider, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Slider_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Slider, cb: fn (w: ?*c.Fl_Slider, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
        c.Fl_Slider_draw(self.inner, cb, data);
    }
};
...
pub const Dial = struct {
    ...
    pub fn handle(self: *Dial, cb: fn (w: ?*c.Fl_Dial, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Dial_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Dial, cb: fn (w: ?*c.Fl_Dial, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Counter = struct {
    ...
    pub fn handle(self: *Counter, cb: fn (w: ?*c.Fl_Counter, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Counter_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Counter, cb: fn (w: ?*c.Fl_Counter, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Scrollbar = struct {
    ...
    pub fn handle(self: *Scrollbar, cb: fn (w: ?*c.Fl_Scrollbar, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Scrollbar_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Scrollbar, cb: fn (w: ?*c.Fl_Scrollbar, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Adjuster = struct {
    ...
    pub fn handle(self: *Adjuster, cb: fn (w: ?*c.Fl_Adjuster, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Adjuster_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Adjuster, cb: fn (w: ?*c.Fl_Adjuster, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Roller = struct {
    ...
    pub fn handle(self: *Roller, cb: fn (w: ?*c.Fl_Roller, ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Roller_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Roller, cb: fn (w: ?*c.Fl_Roller, data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
