...
pub const Valuator = struct {
    ...
    pub fn handle(self: *Valuator, cb: fn (ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Slider_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Valuator, cb: fn (data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Slider = struct {
    ...
    pub fn handle(self: *Slider, cb: fn (ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Slider_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Slider, cb: fn (data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
        c.Fl_Slider_draw(self.inner, cb, data);
    }
};
...
pub const Dial = struct {
    ...
    pub fn handle(self: *Dial, cb: fn (ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Dial_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Dial, cb: fn (data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Counter = struct {
    ...
    pub fn handle(self: *Counter, cb: fn (ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Counter_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Counter, cb: fn (data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Scrollbar = struct {
    ...
    pub fn handle(self: *Scrollbar, cb: fn (ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Scrollbar_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Scrollbar, cb: fn (data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Adjuster = struct {
    ...
    pub fn handle(self: *Adjuster, cb: fn (ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Adjuster_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Adjuster, cb: fn (data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
...
pub const Roller = struct {
    ...
    pub fn handle(self: *Roller, cb: fn (ev: i32, data: ?*c_void) callconv(.C) i32, data: ?*c_void) void {
        c.Fl_Roller_handle(self.inner, cb, data);
    }

    pub fn draw(self: *Roller, cb: fn (data: ?*c_void) callconv(.C) void, data: ?*c_void) void {
